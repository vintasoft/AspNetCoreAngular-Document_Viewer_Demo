...
3. Build the project ("AspNetCoreAngularDocumentViewerDemo.Net7.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build AspNetCoreAngularDocumentViewerDemo.Net7.csproj
   ```
