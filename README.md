...
3. Build the project ("AspNetCoreAngularDocumentViewerDemo.Net10.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build AspNetCoreAngularDocumentViewerDemo.Net10.csproj
   ```
